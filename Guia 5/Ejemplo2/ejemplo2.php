...
<div class="container">
    ...
    <form action="<?= $_SERVER['PHP_SELF']; ?>" method="POST" class="formoid-sol
id-purple">
        ...
        <div class="submit">
            <input type="submit" name="enviar" value="Enviar" class="btn btn-pr
imary" />
        </div>
    </form>
    <?php
...
<script window.jQuery || document.write('<script src="js/jquery.min.js">
</script>')
</script>
