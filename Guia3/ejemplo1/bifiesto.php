...
<body>
    ...
    <form action="<?= $_SERVER['PHP_SELF']; ?>" method="POST" name="frmdatos">
        ...
        <input type="text" name="year" id="year" value="" maxlength="20" placeholder="(ingrese el dato)">
        <br />
    ...
    <?php
            ...
            //Script que determina si un año es bifiesto o no 
            $year = isset($_POST['year']) ? $_POST['year'] : 0;
            if(($year%4 == 0 && $year%100 != 0) || $year%400  == 0):
             echo "<p class=\"bifiesto\">";
             echo "<span style=\"color:Green; font:bold 10pt 'Lucida Sans';\">El año $year es bifiesto</span><br />\n";
             echo "<span style=\"color:Green; font:bold 10pt 'Lucida Sans';\"><a href=\"{$_SERVER['PHP_SELF']}\">Probar otro año</a>";
             echo "</p>";
        else:
            echo "<p class=\"bifiesto\">";
            echo "<span style=\"color:FireBrick; font:bold 10pt 'Lucida Sans';\">El año $year no es bifiesto</span><br />\n";
